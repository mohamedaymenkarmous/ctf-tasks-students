...
if (isset($_POST['username']) && isset($_POST['password'])) {
	...
	$query = "SELECT username FROM us3rs where username = '" . $_POST['username'] . "' and password = ?";
			...
			<div class="centered">
				<div class="well">
					...
					<input name="submit" class="corb-submit btn btn-primary btn-lg" type="submit" value="Login">
                                        ...
                                        <a href="/?source" target="_blank" class="btn btn-primary">Have a look on the Source code ?</a>
				</div>
			</div>
		</div>
		<?php }else { ?>
