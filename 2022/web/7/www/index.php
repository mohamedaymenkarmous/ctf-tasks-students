		...
		<div class="row">
			<div class="centered">
				<div class="well">
					...
					<br/>
		<?php
			if($_SESSION["flag"]=="1")echo "Oh no! I forget to sanitize the cookies also in the controller! I have never though that you will send the data with no cookies. INSAT{Awesome_Byp4ss_W1th_the_c00kies_deletion}";
